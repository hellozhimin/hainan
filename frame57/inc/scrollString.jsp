        ...
        for(var i=0; i<sourceStr.length; i++)
        {
           ...
           // alert("=========size========="+size);
            strWidth = strWidth + (typeof(size)=="undefined"?25:size)*1;
             // dom("test").innerHTML +=  i + " sourceStr: " + sourceStr + " strWidth: " + strWidth;
            if (strWidth > (len-2))
            {
                // dom("test").innerHTML += "text: " + i +  sourceStr + " strWidth: " + strWidth;
                retObj.isSub = true;
                retObj.index = i;
...
//            alert(len+"=========strObj.isSub==========="+strObj.isSub)
            if(strObj.isSub)
            {
                if(i == row - 1)
                {
                    retStr += sourceStr.substring(0, strObj.index -4)+"...";
                    break;
                }
    ...
    */
    ...
    function starScroll(id, text, divWidth) {
		if(null != id && document.getElementById(id)){
			...
			if(id.indexOf('programname0_') != -1 && divWidth1 == ''){
				...
				divWidth1 = 145;
			}else if(id.indexOf('column_name') != -1){
				divWidth1 = 240;
			}
