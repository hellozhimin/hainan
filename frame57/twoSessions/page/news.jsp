...
<div style="position:absolute; top:0px; left:0px; width:1280px; height:720px; ">
    ...
    <!--C3-->
    <div id="zzz" class="topsign" style="width:900px;">快资讯</div>
    <!--C3_a1-->
		...
		area0.okEvent = function(isAuto){
			if(select_focus==area0.curDomIndex && select_page==area0.pageNumber && isAuto==undefined){
				...
				if(content_list.length>0){
					...
					window.location.href = "goto_play.jsp?action=out&returnUrl=news.jsp&vodId="+content_list[area0.curDomIndex+_offset].vodId+"&columncode="+load_category_id();
				}
				return;
			}
			get_play_info();
