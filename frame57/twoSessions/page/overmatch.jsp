...
<script type="text/javascript">
	...
	var cookie_cat_id = "overmatch_category_id";
	var cookie_focus = "overmatch";
	...
	function setAreaAttr(){
		...
		area0.okEvent = function(){
			...
			window.location.href = "overmatch_content.jsp?category_id="+category_list[area0.curDomIndex+_offset].category_id+"&isFromOvermatch=1&category_name="+encodeURIComponent(encodeURIComponent(category_list[area0.curDomIndex+_offset].category_name));
		}
	...
	function loadData(){
		focus_logic.getDataByAjax("<%=data_path%>?Action=vod_categories&category_id="+load_category_id()+"&len_px=100&posterflag=1",load_category_list);
	}
