...
<div style="position:absolute; top:0px; left:0px; width:1280px; height:720px; ">
    ...
    <!--C3-->
    <div id="zzz" class="topsign" style="width:900px;">开闭幕</div>
    <!--C3_a1-->
    <div style="position:absolute; left:87px; top:106px; width:362px; height:564px;">
    	<!--list_up&down-->
        <img src="images/page_up.png" style="position:absolute; top:-4px; left:147px;">
        <img src="images/page_down.png" style="position:absolute; bottom:-4px; left:147px;">
    	<!--news_list-->
...
<script type="text/javascript">
	...
	var cookie_cat_id = "opening_closing_ceremony_category_id";
	var cookie_focus = "opening_closing_ceremony";
		...
		area0.okEvent = function(isAuto){
			if(select_focus==area0.curDomIndex && select_page==area0.pageNumber && isAuto==undefined){
				...
				if(content_list.length>0){
					...
					window.location.href = "goto_play.jsp?action=out&returnUrl=opening_closing_ceremony.jsp&vodId="+content_list[area0.curDomIndex+_offset].vodId+"&columncode="+load_category_id();
				}
				return;
			}
			get_play_info();
