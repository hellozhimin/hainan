...
<div style="position:absolute; top:0px; left:0px; width:1280px; height:720px; ">
    ...
    <!--C3-->
    <div id="_title" class="topsign" style="width:900px;"></div>
    <!--C3_a1-->
...
<script type="text/javascript">
	...
	var cookie_cat_id = "overmath_content_id";
	var cookie_focus = "overmath_content";
	var cookie_cat_name = "overmath_content_cookie_cat_name";
	...
	var category_name = "";
	if("<%=category_name%>" == ""){
		category_name = getCookie(cookie_cat_name);
	}else{
		...
		area0.okEvent = function(isAuto){
			if(select_focus==area0.curDomIndex && select_page==area0.pageNumber && isAuto==undefined){
				...
				if(content_list.length>0){
					...
					window.location.href = "goto_play.jsp?action=out&returnUrl=overmatch_content.jsp&vodId="+content_list[area0.curDomIndex+_offset].vodId+"&columncode="+load_category_id();
				}
				return;
			}
			get_play_info();
