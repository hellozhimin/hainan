...
<script type="text/javascript">
	...
	var cookie_cat_id = "theme_category_id";
	var cookie_focus = "theme_content";
		...
		area0.okEvent = function(isAuto){
			if(select_focus==area0.curDomIndex && select_page==area0.pageNumber && isAuto==undefined){
				...
				if(content_list.length>0){
					...
					window.location.href = "goto_play.jsp?action=out&returnUrl=theme_content.jsp&vodId="+content_list[area0.curDomIndex+_offset].vodId+"&columncode="+load_category_id();
				}
				return;
			}
			get_play_info();
