...
<script type="text/javascript">
	...
	var cookie_cat_id = "star_content_category_id";
	var cookie_cat_pic_path = "star_content_pic_path";
	var cookie_focus = "star_content";
	...
	function setAreaAttr(){
		...
		area0.okEvent = function(){
			...
			if(content_list.length>0){
				...
				window.location.href = "goto_play.jsp?action=out&returnUrl=star_content.jsp&vodId="+content_list[area0.curDomIndex+_offset].vodId+"&columncode="+load_category_id();
			}
		}
		//----------------------------------------------page
