...
<ex:search tablename="user_vod" fields="*" order="<%=order%>"
           ...
           curpagenum="<%=curpage%>" pagecount="<%=numperpage%>">
    <%
        ...
        for (int i = 0; i < vodList.size(); i++) {
            ...
            sb.append("contentleng:\"" + contentleng + "\",");
            sb.append("offlinetime:\"" + offlinetime + "\",");
            sb.append("shorttitle:\"" + shorttitle + "\",");
            sb.append("description:\"" + description + "\",");
            sb.append("normalposter:\"" + normalposter + "\",");
            sb.append("mediaservices:\"" + mediaservices + "\",");
            sb.append("starlevel:\"" + starlevel + "\",");
            sb.append("isFav:\"" + isFav + "\"}");
        }
        sb.append("]}");
